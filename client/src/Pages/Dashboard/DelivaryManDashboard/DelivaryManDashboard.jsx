                ...
                <Sidebar collapsed={collapsed} onBackdropClick={() => setToggled(false)} toggled={toggled} breakPoint='lg' backgroundColor='#253031' className='min-h-screen text-white'>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <MenuItem icon={<FaListAlt className='text-xl'></FaListAlt>} component={<NavLink className={({ isActive }) => isActive ? "bg-[#0B0D0D] font-medium uppercase" : "font-medium uppercase"} to="/dashboard/myDeliverys" />}>My DeliveryList</MenuItem>

                            <MenuItem icon={<FaUserTie className='text-xl'></FaUserTie>} component={<NavLink className={({ isActive }) => isActive ? "bg-[#0B0D0D] font-medium uppercase" : "font-medium uppercase"} to="/dashboard/myReview" />}>My Review</MenuItem>
                        </div>
