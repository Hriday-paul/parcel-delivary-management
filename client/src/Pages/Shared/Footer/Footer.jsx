    ...
    <footer className="footer p-10 items-center bg-base-200 text-base-content">
      <Link to={"/"}>
        <div className='flex flex-col items-center gap-y-2'>
          <img src="https://i.ibb.co/gj0mB4d/logo-removebg-preview.png" height={"70"} width={"70"} alt="logo" />
          <h1 className='text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-indigo-950 uppercase'>Delivered</h1>
        </div>
      </Link>
      <nav>
