                ...
                <Sidebar collapsed={collapsed} onBackdropClick={() => setToggled(false)} toggled={toggled} breakPoint='lg' backgroundColor='#253031' className='min-h-screen text-white'>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <MenuItem icon={<FiUsers className='text-xl'></FiUsers>} component={<NavLink className={({ isActive }) => isActive ? "bg-[#0B0D0D] font-medium uppercase" : "font-medium uppercase"} to="/dashboard/users" />}>All Users</MenuItem>
